...
% ---
\input{conf/titulo}% \titulo{Formatação de trabalhos para a UEPG com o uso da classe \abnTeX}
\input{conf/autor} 
\input{conf/local}
\input{conf/data}
\input{conf/orientador}
\input{conf/coorientador}
...
\begin{document}
	...
	\input{pre-textual-elements/dedicatoria}
	
	\begin{agradecimentos}
		\input{pre-textual-elements/agradecimentos}
	...
	% Epígrafe
	% ---
	\input{pre-textual-elements/epigrafe}
	\setlength{\absparsep}{18pt} % ajusta o espaçamento dos parágrafos do resumo
	\begin{resumo}
		\input{pre-textual-elements/resumo}
	\end{resumo}
	...
	% inserir lista de abreviaturas e siglas
	\begin{siglas}
		\input{pre-textual-elements/siglas}
	\end{siglas}
	% ---
	...
	% ---
	\begin{simbolos}
		\input{pre-textual-elements/simbolos}
	\end{simbolos}
	% ---
	...
	\bibliography{bibliography/base}
