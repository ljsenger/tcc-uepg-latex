...
% ---
\input{src/conf/titulo}% \titulo{Formatação de trabalhos para a UEPG com o uso da classe \abnTeX}
\input{src/conf/autor} 
\input{src/conf/local}
\input{src/conf/data}
\input{src/conf/orientador}
\input{src/conf/coorientador}

	
\tipotrabalho{Trabalho de Conclusão de Curso}
% O preambulo deve conter o tipo do trabalho, o objetivo, 
% o nome da instituição e a área de concentração 
\input{src/conf/preambulo}
...
\begin{document}
	...
	\input{src/pre-textual-elements/dedicatoria}
	
	\begin{agradecimentos}
		\input{src/pre-textual-elements/agradecimentos}
	...
	% Epígrafe
	% ---
	\input{src/pre-textual-elements/epigrafe}
	\setlength{\absparsep}{18pt} % ajusta o espaçamento dos parágrafos do resumo
	\begin{resumo}
		\input{src/pre-textual-elements/resumo}
	\end{resumo}
	...
	% inserir lista de abreviaturas e siglas
	\begin{siglas}
		\input{src/pre-textual-elements/siglas}
	\end{siglas}
	% ---
	...
	% ---
	\begin{simbolos}
		\input{src/pre-textual-elements/simbolos}
	\end{simbolos}
	% ---
	...
	\include{src/chapters/introducao}
	\include{src/chapters/revisao}
	\include{src/chapters/metodologia}
	\include{src/chapters/resultados}
	\include{src/chapters/conclusao}
	
	\postextual
	%ljsenger - espaçamento entre o título e o primeiro parágrafo do texto
	\setlength\afterchapskip{18pt}
	%\bibliographystyle{abntex2-alf}
	\bibliography{src/bibliography/base}
